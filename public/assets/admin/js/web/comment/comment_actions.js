...
console.log("comment_actions.js");
...
//! Tanım
var listUrl = "/admin/comment"; //! List Adresi
        ...
        if(nameAdd == '') { 
            ...
            $.ajax({
                ...
                data: {
                    ...
                    role:$('input[id="roleAdd"][lang="'+dataLang+'"]').val(),
                    comment: dataAdd,
...
document.querySelectorAll('#edit_item').forEach(function (i) {
    i.addEventListener('click', function (event) {
        ...
        var roleEdit = $('input[id="roleEdit"][lang="'+dataLang+'"]').val(); //! Başlık
        var dataEdit = ""; //! Veri
