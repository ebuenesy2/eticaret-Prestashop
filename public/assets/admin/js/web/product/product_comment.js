...
//! Tanım
var listUrl = "/admin/product/comment"; //! List Adresi
    ...
    if(commentUserId == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                product_uid: $('#commentProductUidAdd').val(),
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response.status == "success") {
                    ...
                    $('#commentProductUidEdit').val(response.DB.product_uid);
    ...
    if(commentUserId == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                product_uid: $('#commentProductUidEdit').val(),
