...
console.log("product_category.js");
...
//! Tanım
var listUrl = "/admin/product/category"; //! List Adresi
...
$("#new_add").click(function (e) {
    ...
    //! Veriler
    var titleAdd_TR = $('#titleAdd_TR').val();
    ...
    if(titleAdd_TR == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                title_tr: $('#titleAdd_TR').val(),
                title_en: $('#titleAdd_EN').val(),
                title_de: $('#titleAdd_DE').val(),
...
document.querySelectorAll("#editItem").forEach((Item) => {
    Item.addEventListener("click", e => {
        ...
        //! Gösterme
        $('#editModalValueId').html(data_uid); //! Veriyi Gösterme
            ...
            success: function (response) {
                ...
                if(response.status == "success") {
                    ...
                    for (let index = 0; index < response.DB.length; index++) {
                        ...
                        if(element.lang == "tr") { $('#titleEdit_TR').val(element.title); }
...
$("#edit_item").click(function (e) {
    ...
    //! Veriler
    var titleEdit_TR = $('#titleEdit_TR').val();
