...
//! Tanım
var listUrl = "/admin/blog/comment"; //! List Adresi
...
$("#new_add").click(function (e) {
    ...
    //! Veriler
    var commentUserId = $('#commentUserIdAdd').val();
    ...
    if(commentUserId == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                lang: $('#commentLangAdd').val(),
                blog_uid: $('#commentBlogUidAdd').val(),
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response.status == "success") {
                    ...
                    //! Veriler
                    $('#commentUserIdEdit').val(response.DB.userid);
                    $('#commentLangEdit').val(response.DB.lang);
                    $('#commentBlogUidEdit').val(response.DB.blog_uid);
                    $('#commentEdit').html(response.DB.comment);
...
$("#edit_item").click(function (e) {
    ...
    //! Veriler
    var commentUserId = $('#commentUserIdEdit').val();
    ...
    if(commentUserId == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                id:Number(data_id),
                userid:Number(commentUserId),
                lang: $('#commentLangEdit').val(),
                blog_uid: $('#commentBlogUidEdit').val(),
