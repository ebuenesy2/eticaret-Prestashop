                            ...
                            <div class="entry-container max-col-2" data-layout="fitRows">
                                    ...
                                    <article class="entry entry-grid">
                                        ...
                                        <div class="entry-body">
                                            ...
                                            <h2 class="entry-title">
                                                <a href="/blog-single">Cras ornare tristique elit.</a>
                                            </h2><!-- End .entry-title -->
                                            ...
                                            <div class="entry-content">
                                                ...
                                                <a href="blog-single.html" class="read-more">Continue Reading</a>
                                ...
                                <div class="entry-item col-sm-6">
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="blog-single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-5.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                ...
                                <div class="entry-item col-sm-6">
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="blog-single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-6.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                ...
                                <div class="entry-item col-sm-6">
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl">
                                                <a href="blog-single.html">
                                                    <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-7.jpg" alt="image desc">
                                                </a>
                                                <a href="blog-single.html">
                                                    <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-6.jpg" alt="image desc">
                                                </a>
                                ...
                                <div class="entry-item col-sm-6">
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="blog-single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-8.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
