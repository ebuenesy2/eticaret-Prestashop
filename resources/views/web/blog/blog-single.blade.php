                ...
                <div class="container">
                    <figure class="entry-media">
                        <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl">
                            <img src="{{asset('/assets')}}/web/images/blog/single/fullwidth-sidebar/1.jpg" alt="image desc">
                            <img src="{{asset('/assets')}}/web/images/blog/single/fullwidth-sidebar/2.jpg" alt="image desc">
                            <img src="{{asset('/assets')}}/web/images/blog/single/fullwidth-sidebar/3.jpg" alt="image desc">
                            ...
                            <article class="entry single-entry">
                                <div class="entry-body">
                                    ...
                                    <div class="entry-content editor-content">
                                        ...
                                        <img src="{{asset('/assets')}}/web/images/blog/single/fullwidth-sidebar/4.jpg" alt="image">
                                        <img src="{{asset('/assets')}}/web/images/blog/single/fullwidth-sidebar/5.jpg" alt="image">
                                ...
                                <div class="entry-author-details">
                                    <figure class="author-media">
                                        <a href="#">
                                            <img src="{{asset('/assets')}}/web/images/blog/single/author.jpg" alt="User name">
                                        </a>
                            ...
                            <div class="related-posts">
                                ...
                                <div class="owl-carousel owl-simple" data-toggle="owl" 
                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-1.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-2.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-3.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{asset('/assets')}}/web/images/blog/grid/3cols/post-4.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                ...
                                <ul>
                                    <li>
                                        <div class="comment">
                                            <figure class="comment-media">
                                                <a href="#">
                                                    <img src="{{asset('/assets')}}/web/images/blog/comments/1.jpg" alt="User name">
                                                </a>
                                            </figure>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="comment">
                                                    <figure class="comment-media">
                                                        <a href="#">
                                                            <img src="{{asset('/assets')}}/web/images/blog/comments/2.jpg" alt="User name">
                                                        </a>
                                                    </figure>
                                    ...
                                    <li>
                                        <div class="comment">
                                            <figure class="comment-media">
                                                <a href="#">
                                                    <img src="{{asset('/assets')}}/web/images/blog/comments/3.jpg" alt="User name">
                                                </a>
                                            </figure>
                			...
                			<div class="sidebar">
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="posts-list">
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src="{{asset('/assets')}}/web/images/blog/sidebar/post-1.jpg" alt="post">
                                                </a>
                                            </figure>
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src="{{asset('/assets')}}/web/images/blog/sidebar/post-2.jpg" alt="post">
                                                </a>
                                            </figure>
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src="{{asset('/assets')}}/web/images/blog/sidebar/post-3.jpg" alt="post">
                                                </a>
                                            </figure>
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src="{{asset('/assets')}}/web/images/blog/sidebar/post-4.jpg" alt="post">
                                                </a>
                                            </figure>
                                ...
                                <div class="widget widget-banner-sidebar">
                                    ...
                                    <div class="banner-sidebar">
                                        <a href="#">
                                            <img src="{{asset('/assets')}}/web/images/blog/sidebar/banner.jpg" alt="banner">
                                        </a>
                                    </div><!-- End .banner-ad -->
                                </div><!-- End .widget -->
