...
<!-- Head -->
<title> @lang('admin.roleList') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.roleList'); ?>
...
<body class="fixed-top" id="listInfoData" page={{$page}} rowCountData={{$rowcount}} orderData={{$order}} > 
                          ...
                          <table>
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                              ...
                              <tr>
                                  ...
                                  <td data-cell="@lang('admin.role')">{{$dbFind[$i]->title}}</td>
          ...
          <div class="span12">
              <div class="control-group">
                ...
                <div class="controls controls-row">
                    <input type="text" class="input-block-level" name="titleAdd" id="titleAdd" placeholder="@lang('admin.role')" value="" focusType ="true" focusControl="add" focusControl_Active="true"  focusOrder="1"  >
                </div>
              </div>
          </div>
        </div>
        ...
        <div class="row-fluid">
          <div class="span12">
              <div class="control-group">
                <label class="control-label">@lang('admin.role')</label>
                <div class="controls controls-row">
                    <input type="text" class="input-block-level" name="titleEdit" id="titleEdit" placeholder="@lang('admin.role')" value=""  focusType ="true" focusControl="edit" focusControl_Active="true"  focusOrder="1" >
                </div>
              </div>
          </div>
        </div>
  ...
  <footer>
    ...
    <script src="{{asset('/assets/admin')}}/js/settings/setting_roleList.js"></script>
