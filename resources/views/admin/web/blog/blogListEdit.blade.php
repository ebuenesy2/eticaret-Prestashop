...
<!-- Head -->
<title> Blog - @lang('admin.edit') #{{ $DB_Find_tr->uid }} | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = 'Blog' ?>
<?php $listUrl = "/admin/blog";  ?>
...
<body class="fixed-top" id="dataValueInfo" data_action="edit" data_uid="{{ $DB_Find_tr->uid }}">
                                ...
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls controls-row">
                                            <select class="span12" style="cursor: pointer;" id="blogCategoryEdit"   >
                                                @for ($i = 0; $i < count($DB_Find_blogs_categories); $i++)
                                                    @if($DB_Find_en) 
                                                    <option value="{{$DB_Find_blogs_categories[$i]->uid}}" {{ $DB_Find_en->category == $DB_Find_blogs_categories[$i]->uid ? 'selected' : ''}} >{{$DB_Find_blogs_categories[$i]->title}}</option>
                                                    @elseif($DB_Find_de) 
                                                    <option value="{{$DB_Find_blogs_categories[$i]->uid}}" {{ $DB_Find_de->category == $DB_Find_blogs_categories[$i]->uid ? 'selected' : ''}} >{{$DB_Find_blogs_categories[$i]->title}}</option>
                                                    @else
                                                    <option value="{{$DB_Find_blogs_categories[$i]->uid}}" {{ $DB_Find_tr->category == $DB_Find_blogs_categories[$i]->uid ? 'selected' : ''}} >{{$DB_Find_blogs_categories[$i]->title}}</option>
                                                    @endif
                                                @endfor
                                            </select>
                                        </div>
   ...
   <!------- Js --->
   <script src="{{asset('/assets/admin')}}/js/web/blog/blogList_actions.js"></script>
