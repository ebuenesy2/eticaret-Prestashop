...
<!-- Head -->
<title> Blog - @lang('admin.newAdd') | {{ config('admin.Admin_Title') }} </title>
                ...
                <div class="span6" id="leftAdd">
                    ...
                    <div class="widget red">
                        <div class="widget-title">
                            <h4><i class="fa fa-edit"></i>  @lang('admin.add') - @lang('admin.information')  </h4>
                                ...
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls controls-row">
                                            <select class="span12" style="cursor: pointer;" id="blogCategoryAdd"   >
                                                @for ($i = 0; $i < count($DB_Find_blogs_categories); $i++)
                                                <option value="{{$DB_Find_blogs_categories[$i]->uid}}" >{{$DB_Find_blogs_categories[$i]->title}}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="widget blue">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">Seo - Keywords - En</label>
                                        ...
                                        <div class="tagInputBox" id="tagInputBox">
                                            ...
                                            <div class="tagRight">
                                                ...
                                                <div id="tagCancel"><i style="font-size: 30px; color: red;" lang="en" class="fa fa-times" aria-hidden="true"></i>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="widget yellow">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">Seo - Keywords De</label>
