...
<!-- Head -->
<title> Slider - @lang('admin.newAdd') | {{ config('admin.Admin_Title') }} </title>
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls controls-row">
                                            <input type="text" class="input-block-level" name="title2Add" id="title2Add"  lang="tr" placeholder="@lang('admin.title') 2" value="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls controls-row">
                                            <input type="text" class="input-block-level" name="urlAdd" id="urlAdd"  lang="tr" placeholder="Url" value="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="widget blue">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">@lang('admin.title') 2 - EN</label>
                                        <div class="controls controls-row">
                                            <input type="text" class="input-block-level" name="title2Add" id="title2Add"  lang="en" placeholder="@lang('admin.title') 2" value="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">Url</label>
                                        <div class="controls controls-row">
                                            <input type="text" class="input-block-level" name="urlAdd" id="urlAdd"  lang="en" placeholder="Url" value="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="widget yellow">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">@lang('admin.title') 2 - DeEN</label>
                                        <div class="controls controls-row">
                                            <input type="text" class="input-block-level" name="title2Add" id="title2Add"  lang="de" placeholder="@lang('admin.title') 2" value="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">Url</label>
                                        <div class="controls controls-row">
                                            <input type="text" class="input-block-level" name="urlAdd" id="urlAdd"  lang="de" placeholder="Url" value="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
