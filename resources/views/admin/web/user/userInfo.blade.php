...
<!-- Head -->
<title> @lang('admin.userInfo') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.userInfo'); ?>
...
<!-- BEGIN BODY -->
<body class="fixed-top" id="userInfo" userId="{{$DB_Find->id}}"  >
            ...
            <div class="row-fluid">
               <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/@lang('admin.lang'){{$listUrl}}/list">@lang('admin.userList')</a>
                            <span class="divider">/</span>
                        </li>
                                ...
                                <ul class="nav nav-tabs navtab-custom">
                                    <li class="active">
                                        <a href="#home" data-toggle="tab" aria-expanded="true">
                                            ...
                                            <span class="hidden-xs">@lang('admin.userInfo')</span>
                                        </a>
                                    </li>
                                    <li class="hidden">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls controls-row">
                                                            <select class="span12" style="cursor: pointer;" name="userRole" id="userRole"  focusType ="true" focusControl="edit_user" focusControl_Active="true" focusOrder="5" >
                                                                <option value="1" {{ $DB_Find->role_id == "1" ? 'selected' : ''}} >@lang('admin.customer')</option>
                                                                <option value="2" {{ $DB_Find->role_id == "2" ? 'selected' : ''}}  >@lang('admin.company')</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
