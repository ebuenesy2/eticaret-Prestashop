...
<!-- Head -->
<title> @lang('admin.orderProductList') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.orderProductList'); ?>
<?php $listUrl = "/admin/web/user/order/product";  ?>
                        ...
                        <div class="table-container">
                          ...
                          <table>
                              <thead>
                                ...
                                <th class="table_title" exportName="id" >Sayısı</th>
