...
<!-- Head -->
<title> @lang('admin.myWishList') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.myWishList'); ?>
<?php $listUrl = "/admin/web/user/wish";  ?>
...
<body class="fixed-top" id="listInfoData" page={{$page}} rowCountData={{$rowcount}} orderData={{$order}} > 
  ...
  <footer>
    ...
    <script src="{{asset('/assets/admin')}}/js/web/user/userWish.js"></script>
