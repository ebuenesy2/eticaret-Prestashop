...
<!-- Head -->
<title> @lang('admin.service') - @lang('admin.newAdd') | {{ config('admin.Admin_Title') }} </title>
                                ...
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls controls-row">
                                            <select class="span12" style="cursor: pointer;" id="categoryAdd"   >
                                                @for ($i = 0; $i < count($DB_Find_service_categories); $i++)
                                                <option value="{{$DB_Find_service_categories[$i]->uid}}" >{{$DB_Find_service_categories[$i]->title}}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
