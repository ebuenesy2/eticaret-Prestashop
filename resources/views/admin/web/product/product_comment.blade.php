...
<!-- Head -->
<title> @lang('admin.product') - @lang('admin.comment') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.product').' '. __('admin.comment'); ?>
<?php $listUrl = "/admin/product/comment";  ?>
...
<body class="fixed-top" id="listInfoData" page={{$page}} rowCountData={{$rowcount}} orderData={{$order}} > 
                    ...
                    <div>
                      <div class="clearfix">
                        ...
                        <div class="row-fluid" style="margin-top:10px;display: flex;gap: 5px;flex-wrap: wrap;" >
                          ...
                          <div style="display: flex;flex-direction: column;">
                            <p>Product Uid</p>
                            <input type="number" placeholder="product_uid" class="" id="searchTable" searchName="product_uid" style="width: 120px;" >
                          </div>
                          <!------ Arama Product Uid  Son----->
                          ...
                          <table>
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                              ...
                              <tr>
                                  ...
                                  <td data-cell="@lang('admin.product') ID" >{{$dbFind[$i]->product_uid}}</td>
  ...
  <div id="addModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <div class="row-fluid">
          ...
          <div class="span6">
              <div class="control-group">
                <label class="control-label">Product Uid</label>
                <div class="controls controls-row">
                  <input type="number" class="input-block-level" name="commentProductUidAdd" id="commentProductUidAdd" placeholder="0" value="0" focusType ="true" focusControl="add" focusControl_Active="false" focusOrder="3" >
                </div>
              </div>
          </div>
        </div>       
        ...
        <div class="row-fluid">
          ...
          <div class="span6">
              <div class="control-group">
                <label class="control-label">Product Uid</label>
                <div class="controls controls-row">
                  <input type="number" class="input-block-level" name="commentProductUidEdit" id="commentProductUidEdit" placeholder="0" value="0" focusType ="true" focusControl="edit" focusControl_Active="false" focusOrder="3" >
                </div>
              </div>
          </div>
        </div>       
  ...
  <footer>
    ...
    <script src="{{asset('/assets/admin')}}/js/web/product/product_comment.js"></script>
