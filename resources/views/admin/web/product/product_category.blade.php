...
<!-- Head -->
<title> @lang('admin.productCategory') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.productCategory') ?>
<?php $listUrl = "/admin/product/category";  ?>
...
<body class="fixed-top" id="listInfoData" page={{$page}} rowCountData={{$rowcount}} orderData={{$order}} > 
  ...
  <footer>
    ...
    <script src="{{asset('/assets/admin')}}/js/web/product/product_category.js"></script>
