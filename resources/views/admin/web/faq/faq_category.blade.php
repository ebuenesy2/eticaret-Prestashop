...
<!-- Head -->
<title> @lang('admin.faqCategory') | {{ config('admin.Admin_Title') }} </title>
@include('admin.include.head')

<!-- Tanım -->
<?php $homeUrl = '/admin'; ?>
<?php $listTitle = __('admin.faqCategory') ?>
...
<body class="fixed-top" id="listInfoData" page={{$page}} rowCountData={{$rowcount}} orderData={{$order}} > 
  ...
  <footer>
    ...
    <script src="{{asset('/assets/admin')}}/js/web/faq/faq_category.js"></script>
