...
<!-- Head -->
<title> @lang('admin.adminList') | {{ config('admin.Admin_Title') }} </title>
                    ...
                    <div>
                      <div class="clearfix">
                        ...
                        <div class="row-fluid" style="margin-top:10px;display: flex;gap: 5px;flex-wrap: wrap;" >
                          ...
                          <div style="display: flex;flex-direction: column;" >
                            <p>@lang('admin.role')</p>
                            <select class="" style="cursor: pointer; width: max-content;" id="searchTable" searchName="role"  >
                                <option value="">@lang('admin.all')</option>
                                @for ($i = 0; $i < count($DB_Find_roles); $i++)
                                  <option value="{{$DB_Find_roles[$i]->id}}" >{{$DB_Find_roles[$i]->title}}</option>
                                @endfor
                            </select>
                          </div>
                          <!------ Arama Role Son----->
                          ...
                          <!------ Arama Departman ----->
                          <div style="display: flex;flex-direction: column;" >
                            <p>@lang('admin.department')</p>
                            <select class="" style="cursor: pointer; width: max-content;" id="searchTable" searchName="departman"  >
                                <option value="">@lang('admin.all')</option>
                                @for ($i = 0; $i < count($DB_Find_departman); $i++)
                                  <option value="{{$DB_Find_departman[$i]->id}}" >{{$DB_Find_departman[$i]->title}}</option>
                                @endfor
                            </select>
                          </div>
                          <!------ Arama Departman Son----->
        ...
        <div class="row-fluid">
          ...
          <div class="span6">
              <div class="control-group">
                ...
                <select class="span12" style="cursor: pointer;" name="userDepartman" id="userDepartman" focusType ="true" focusControl="add" focusControl_Active="false" focusOrder="4" >
                    @for ($i = 0; $i < count($DB_Find_departman); $i++)
                      <option value="{{$DB_Find_departman[$i]->id}}" >{{$DB_Find_departman[$i]->title}}</option>
                    @endfor
                </select>
        ...
        <div class="row-fluid">
          <div class="span6">
              <div class="control-group">
                ...
                <select class="span12" style="cursor: pointer;" name="userRole" id="userRole" focusType ="true" focusControl="add" focusControl_Active="false" focusOrder="5"  >
                    @for ($i = 0; $i < count($DB_Find_roles); $i++)
                      <option value="{{$DB_Find_roles[$i]->id}}" >{{$DB_Find_roles[$i]->title}}</option>
                    @endfor
                </select>
          ...
          <div class="span6">
              <div class="control-group">
                ...
                <select class="span12" style="cursor: pointer;" name="statusAdd" id="statusAdd" focusType ="true" focusControl="add" focusControl_Active="false" focusOrder="6" >
                  <option value="1" >@lang('admin.active')</option>
                  <option value="0" >@lang('admin.passive')</option>
                </select>
              </div>
        ...
        <div class="row-fluid">
          <div class="span6">
              <div class="control-group">
                  ...
                  <div class="controls controls-row">
                      <input type="password" class="input-block-level" name="passwordAdd" id="passwordAdd" placeholder="@lang('admin.password')" value="" focusType ="true" focusControl="add" focusControl_Active="false" focusOrder="7" >
                  </div>
              </div>
          </div>
          <div class="span6">
              <div class="control-group">
                  ...
                  <div class="controls controls-row">
                      <input type="password" class="input-block-level" name="rePasswordAdd" id="rePasswordAdd" placeholder="@lang('admin.password')" value="" focusType ="true" focusControl="add" focusControl_Active="true" focusOrder="8" >
                  </div>
              </div>
          </div>
        </div>
